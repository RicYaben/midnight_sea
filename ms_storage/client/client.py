...
from ms_storage.client.interfaces import ServiceFactory

# Necessary Imports for the "ServiceFactory" to register the services
from ms_storage.client.services import scraper
from ms_storage.globals import CERTS, SERVICES, logger
    ...
    def build(self, services: dict):
        ...
        for service, attrs in services.items():
            ...
            if host and port:
                ...
                # Create a local instance of teh stub
